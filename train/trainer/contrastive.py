...
# Dataset para ContrastiveLoss
dataset = load_dataset("Lauther/d4-embeddings")
dataset = dataset.rename_column("posneg", "label")
...
base="d4-embeddings-v2.0-ContrastiveLoss"
output_dir =  f".models/finetuned--{base}"
log_dir = f"{output_dir}/logs"
num_epochs = 10
batch_size = 128
